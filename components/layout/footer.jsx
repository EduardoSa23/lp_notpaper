        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            ...
            <div className="flex justify-center space-x-4 md:justify-start">
              <a
                href="https://www.linkedin.com/company/silo-tecnologia/"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/quem-somos" className="transition-colors hover:text-white">
                  Quem Somos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/diretoria/login" className="transition-colors hover:text-white">
                  Login
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                Telefone:{" "}
                <a href="tel:+551146040000" className="hover:text-white">
                  (11) 4604-0000
                </a>
              </li>
              <li>
                WhatsApp:{" "}
                <a href="https://wa.me/5511941398031" className="hover:text-white" target="_blank" rel="noreferrer">
                  (11) 94139-8031
                </a>
              </li>
              <li>
                E-mail:{" "}
                <a href="mailto:contato@notpaper.com.br" className="hover:text-white">
                  contato@notpaper.com.br
                </a>
              </li>
              <li>
                Endereço:{" "}
                <a
                  ...
                  rel="noreferrer"
                >
                  Av. Deputado Castro de Carvalho, 941, Poá - SP
                </a>
              </li>
            </ul>
          </div>
