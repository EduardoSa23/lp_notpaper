...
const fundamentos = [
  {
    icon: FaBullseye,
    title: "Missão",
    description: "Desenvolver soluções tecnológicas que simplificam processos, automatizam rotinas e geram valor para a gestão pública.",
  },
  {
    icon: FaEye,
    title: "Visão",
    description: "Ser referência em transformação digital para prefeituras, impulsionando cidades mais eficientes, sustentáveis e conectadas.",
  },
  {
    icon: FaDiagramProject,
    title: "Valores",
    description: "Construímos relações duradouras baseadas em confiança, colaboração e evolução contínua.",
